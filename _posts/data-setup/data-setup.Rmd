...
Now we load the clinical data. The data was downloaded from [tranSMART](https://transmart.quartzbio.com/transmart/login/auth) on December 5th, 2018.    

```{r preview = FALSE, eval = FALSE, include = TRUE, echo = TRUE, warning = FALSE, message = FALSE, comment = NA, R.options = list(width = 70)}
data <- read_tsv(name(folder = "", file = "data_clinical", type = ".tsv"))
```
